...
-- -----------------------------------------------------
-- Table `WIWork`.`Usuário`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `WIWork`.`Usuário` (
  ...
  UNIQUE INDEX `Id Usuário_UNIQUE` (`Id Usuário` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `WIWork`.`Chat` (
  ...
  `remetente_Id Usuário` INT NOT NULL,
  `destinatario_id_usuario` INT NULL,
  INDEX `fk_Chat_Usuário1_idx` (`remetente_Id Usuário` ASC, `destinatario_id_usuario` ASC) VISIBLE,
  CONSTRAINT `fk_Chat_Usuário1`
    FOREIGN KEY (`remetente_Id Usuário` , `destinatario_id_usuario`)
    REFERENCES `WIWork`.`Usuário` (`Id Usuário` , `Id Usuário`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `WIWork`.`aluno_tem_Cursos` (
  ...
  INDEX `fk_Usuário_has_Cursos_Usuário1_idx` (`Usuário_Id Usuário` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Usuário_has_Cursos_Usuário1`
    ...
    REFERENCES `WIWork`.`Usuário` (`Id Usuário`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `WIWork`.`Usuário_avalia_Cursos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `WIWork`.`Usuário_avalia_Cursos` (
  `Usuário_Id Usuário` INT NOT NULL,
  `Cursos_Id Cursos` INT NOT NULL,
  PRIMARY KEY (`Usuário_Id Usuário`, `Cursos_Id Cursos`),
